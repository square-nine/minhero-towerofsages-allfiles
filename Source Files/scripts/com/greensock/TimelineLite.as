package com.greensock
{
   ...
   public class TimelineLite extends SimpleTimeline
   {
      ...
      override public function insert(param1:TweenCore, param2:* = 0) : TweenCore
      {
         ...
         if(!param1.cachedOrphan && Boolean(_loc3_))
         {
         ...
         {
            _loc6_ = _loc5_;
            _loc7_ = param1.cachedStartTime;
            while(_loc6_ != null && _loc7_ < _loc6_.cachedStartTime)
            {
         ...
         if(this.gc)
         {
            this._endCaps[0] = _loc4_;
            this._endCaps[1] = _loc5_;
         }
         else
         {
            _firstChild = _loc4_;
         ...
         if(this.gc && !this.cachedPaused && this.cachedTime == this.cachedDuration && this.cachedTime < this.duration)
         {
            ...
            while(_loc8_.gc && Boolean(_loc8_.timeline))
            {
      ...
      override public function renderTime(param1:Number, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         if(param1 >= _loc4_)
         {
            if((_loc5_ != _loc4_ || this.cachedDuration == 0) && _rawPrevTime != param1)
            {
               this.cachedTotalTime = this.cachedTime = _loc4_;
               this.forceChildrenToEnd(_loc4_,param2);
               _loc9_ = !this.hasPausedChild() && !this.cachedReversed;
               _loc10_ = true;
         ...
         else if(param1 <= 0)
         {
            ...
            if(_loc5_ != 0 && _rawPrevTime != param1)
            {
      ...
      public function killTweensOf(param1:Object, param2:Boolean = true, param3:Object = null) : Boolean
      {
         ...
         var _loc4_:Array;
         var _loc5_:int = int((_loc4_ = this.getTweensOf(param1,param2)).length);
         while(--_loc5_ > -1)
         {
