package BattleSystems.Visuals.VisualMoves
{
   ...
   public class VisualMoveStunned extends BaseVisualMove
   {
       
      
      private var m_statBackground:Sprite;
      
      public function VisualMoveStunned()
      {
         super();
         m_moveTime = 0.9;
      }
      ...
      override public function CreateMove(param1:Sprite, param2:BaseMinionMove, param3:OwnedMinion, param4:OwnedMinion) : void
      {
         ...
         this.m_statBackground = Singleton.utility.m_spriteHandler.CreateSprite("visualMove_stunned");
      ...
      {
         super.PlayMove();
         Singleton.utility.m_soundController.PlaySound("battle_spark",1);
