package com.google.analytics.campaign
{
   ...
   public class CampaignManager
   {
      ...
      public function getCampaignInformation(param1:String, param2:Boolean) : CampaignInfo
      {
         ...
         if(isValid(_loc4_))
         {
            if((_loc6_ = hasNoOverride(param1)) && !_buffer.hasUTMZ())
            {
               return _loc3_;
            }
         }
         ...
         {
            (_loc8_ = new CampaignTracker()).fromTrackerString(_buffer.utmz.campaignTracking);
      ...
      public function getTrackerFromSearchString(param1:String) : CampaignTracker
      {
         ...
         if((_loc5_ = new Variables(param1)).hasOwnProperty(_loc4_.UCID))
         {
